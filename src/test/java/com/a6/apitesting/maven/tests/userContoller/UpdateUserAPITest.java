...
public class UpdateUserAPITest {
  ...
  // Test case to update gender. TC16
  @Test
  public void testUpdateUserWithValidUserIdAndGender() throws IOException{
    String filePath = "src/test/resources/testdata/userUpdateDataTC05-Data.json";
    String jsonBody = TestUtilities.loadJsonFromFile(filePath);
    Response response = RestAssured.given()
                                    .spec(APIConfig.getDefaultRequestSpecification())
                                    .body(jsonBody)
